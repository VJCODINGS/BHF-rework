            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="{{ route('boardinghouses.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-6 text-center">
                        <label class="block text-lg font-medium">House Picture</label>
                    ...
                    <div class="mb-6">
                        <label class="block text-lg font-medium">Boarding House Photos</label>
                        <div class="w-full h-32 border border-dashed border-gray-400 rounded-lg p-2 bg-gray-100 relative" id="photos-dropzone">
                            ...
                            <p class="text-center text-sm text-gray-500 mt-10">Drag & drop or click to upload photos</p>
                        </div>
